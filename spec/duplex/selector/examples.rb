...
shared_examples_for "Selector #with_path" do
...
shared_examples_for "Selector #with_path chained" do
  let(:refs) {[
...
shared_examples_for "Selector #with_name" do
...
shared_examples_for "Selector #with_name chained" do
  let(:refs) {[
    create_file_ref(path: "/example/path/document.txt"),
    create_file_ref(path: "/example/dir/text.doc"),
    create_file_ref(path: "/sample/path/document.txt")
...
shared_examples_for "Selector #with_ext" do
  let(:ext_1) { ".jpg" }
  let(:ext_2) { ".png" }
...
shared_examples_for "Selector #with_ext chained" do
  let(:refs) {[
    create_file_ref(path: "/example/path/document.txt"),
    create_file_ref(path: "/example/dir/text.doc"),
    create_file_ref(path: "/sample/path/document.txt")
...
shared_examples_for "Selector #with_sha" do
...
shared_examples_for "Selector #with_sha chained" do
  let(:refs) {[
    create_file_ref(path: "/example/path/document.txt"),
    create_file_ref(path: "/example/dir/text.doc"),
    create_file_ref(path: "/sample/path/document.txt")
...
shared_examples_for "Selector #with_size" do
  it "calls the given block" do
...
shared_examples_for "Selector #with_size chained" do
  let(:refs) {[
    create_file_ref(path: "/example/path/document.txt"),
    create_file_ref(path: "/example/dir/text.doc"),
    create_file_ref(path: "/sample/path/document.txt")
...
shared_examples_for "Selector #with_uniq_name" do
  let(:name_1) { "example_name" }
  let(:name_2) { "sample_name" }
...
shared_examples_for "Selector #with_uniq_name chained" do
  let(:refs) {[
    create_file_ref(path: "/example/path/document.txt"),
    create_file_ref(path: "/example/dir/text.doc"),
    create_file_ref(path: "/sample/path/document.txt")
...
shared_examples_for "Selector #with_uniq_location" do
  let(:location_1) { "/example_path" }
  let(:location_2) { "/sample_path" }
...
shared_examples_for "Selector #with_uniq_location chained" do
  let(:refs) {[
    create_file_ref(path: "/example/path/document.txt"),
...
shared_examples_for "Selector #each chained" do
  let(:refs) {[
    create_file_ref(path: "/example/path/document.txt"),
    create_file_ref(path: "/example/dir/text.doc"),
    create_file_ref(path: "/sample/path/document.txt")
...
shared_examples_for "Selector #all" do
  it "calls the given block" do
...
shared_examples_for "Selector #all chained" do
  let(:refs) {[
    create_file_ref(path: "/example/path/document.txt"),
    create_file_ref(path: "/example/dir/text.doc"),
    create_file_ref(path: "/sample/path/document.txt")
